...
transmission_type = col2.selectbox("Select the tranmission type", ["Manually","Automatic"])
...
if st.button("Get Price"):
    ...
    input_data = [2012,2,120000,encoded_fuel_type,encoded_transmission_type,19,engine,46,seats]
